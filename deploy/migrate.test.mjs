...
test("el catálogo de planes permite bootstrap parcial pero exige cierre exacto", () => {
  ...
  const starter = {
    ...
    includesMfa: false,
    includesApi: false,
    monthlyPriceCop: "290000.00",
    yearlyPriceCop: "3480000.00",
    isActive: true,
    sortOrder: 2,
  };
  const professional = {
    ...
    includesMfa: true,
    includesApi: false,
    monthlyPriceCop: "990000.00",
    yearlyPriceCop: "11880000.00",
    isActive: true,
    sortOrder: 3,
  };
  const enterprise = {
    ...
    includesMfa: true,
    includesApi: false,
    monthlyPriceCop: "3500000.00",
    yearlyPriceCop: "42000000.00",
    isActive: true,
    sortOrder: 4,
  };
