...
export default function FinanzasPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    toastSuccess(`Movimiento por ${formatCOP(monto)} registrado`);
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-zinc-500 font-medium italic text-sm">
          Control estricto de topes legales y reporte de gastos.
        </p>
      </header>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h3 className="text-xl font-black text-[#111827] tracking-tight">
                Estado de Tope Legal
              </h3>
            </div>
            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">
              Límite: 2.500 Millones
            </span>
          </div>
            ...
            <div className="h-4 w-full bg-zinc-100 rounded-full overflow-hidden p-1 shadow-inner relative">
              <div
                className={cn(
                  ...
                  isCritical
                    ? "bg-red-500"
                    : budget.porcentajeEjecucionTope > 70
                      ? "bg-amber-500"
                      : "bg-emerald-500",
                )}
                style={{
                  width: `${Math.min(budget.porcentajeEjecucionTope, 100)}%`,
                }}
              />
            </div>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-50">
                <th className="px-10 py-5 text-[10px] font-black text-zinc-300 uppercase tracking-widest">
                  Concepto / Categoría
                </th>
                <th className="px-10 py-5 text-[10px] font-black text-zinc-300 uppercase tracking-widest">
                  Fecha
                ...
                <th className="px-10 py-5 text-right text-[10px] font-black text-zinc-300 uppercase tracking-widest">
                  Monto
                </th>
              </tr>
            </thead>
