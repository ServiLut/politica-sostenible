  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-zinc-500 font-medium italic">
            Operación de Control Electoral 2026
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {[
          {
            label: "E-14 Recolectados",
            value: "1,204",
            icon: FileText,
            color: "primary",
          },
          {
            label: "Mesas en Alerta",
            value: "12",
            icon: AlertCircle,
        ...
        <div className="p-0">
          <table className="w-full text-left">
            ...
            <tbody>
              {[
                {
                  name: "Col. Marco Fidel Suárez",
                  loc: "Itagüí, Antioquia",
                  count: "12/12",
                  status: "Completo",
                },
                {
                  name: "Inst. Educativa Nacional",
                  loc: "Bogotá, Suba",
                  count: "8/20",
                  status: "Parcial",
                },
                {
                  name: "Escuela Rural La Paz",
                  loc: "Valle del Cauca",
                  count: "0/2",
                  status: "Pendiente",
                },
