    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">
            Control de accesos inmutable y monitor de integridad de datos.
          </p>
        </div>
        <div className="flex items-center gap-4 bg-white p-2 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <button
            onClick={() => {
              ...
              if (!panicMode)
                alert(
                  "MODO PÁNICO ACTIVADO: Bloqueando exportaciones y cerrando sesiones no autorizadas...",
                );
            }}
            className={cn(
      ...
      <div className="bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden">
        <div className="flex items-center gap-3 mb-10 border-b border-white/10 pb-6">
          ...
          <span className="ml-auto text-[10px] font-black text-blue-400 uppercase tracking-[0.3em]">
            Inmutable System
          </span>
        </div>
        ...
        <div className="space-y-4 font-mono text-xs">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-white/70">
                  <span className="text-white/40 uppercase text-[9px] font-black mr-2">
                    [{log.module}]
                  </span>
                  {log.action}
                </p>
          ...
          {auditLogs.length === 0 && (
            <div className="text-center py-20 text-white/20">
              ...
              <p className="uppercase font-black tracking-widest">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-3xl flex items-center gap-6">
        ...
        <div>
          <p className="text-blue-900 font-black text-sm mb-1">
            Protección de Datos Activa
          </p>
          <p className="text-blue-700 text-xs">
            Este sistema cumple con los estándares de encriptación de grado
            militar y registra cada movimiento de información sensible de
