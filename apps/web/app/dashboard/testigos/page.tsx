      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-[#111827] tracking-tighter">
            Ejército de Testigos
          </h1>
          <p className="text-zinc-500 font-medium italic text-sm">
            Cuidado de votos y reporte de actas E-14 para el Día D.
          </p>
        </div>
        <button
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-50">
                <th className="px-10 py-6 text-[10px] font-black text-zinc-300 uppercase tracking-[0.2em]">
                ...
                >
                  ...
                  <td className="px-10 py-7">
                    <div className="flex items-center gap-4">
                      ...
                      <button
                        onClick={() =>
                          alert(`Conectando por WhatsApp con ${w.nombre}...`)
                        }
          ...
          <div className="bg-white w-full max-w-xl rounded-[3.5rem] p-12 shadow-2xl animate-in zoom-in-95 duration-300 relative">
            ...
            <div className="mb-10 text-center">
              ...
              <p className="text-zinc-500 font-medium italic mt-2">
                Diligencia los datos para asignar un guardián de mesa.
              </p>
            </div>

            <form onSubmit={handleSave} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-zinc-400 tracking-[0.2em] ml-2">
                  Nombre Completo
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      asignado_a_puesto: e.target.value,
                    })
                  }
              ...
              <button
                type="submit"
                className="w-full py-6 bg-[#111827] text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-zinc-900/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-4 group"
              >
                Vincular Testigo
                <ChevronRight
                  size={18}
