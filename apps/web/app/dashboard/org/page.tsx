...
export default function OrgPage() {
  const { team, inviteMember, updateMember, toggleMemberStatus, getTeamStats } =
    useCRM();
  ...
  const [newMember, setNewMember] = useState<
    Omit<TeamMember, "id" | "performance" | "status">
  >({
    name: "",
    role: "Voluntario",
    territory: "",
  ...
  const isAdmin =
    currentUserRole === "SuperAdmin" || currentUserRole === "AdminCampana";
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">
            Gestión de la estructura jerárquica y nodos operativos.
          </p>
        </div>
        <button
          ...
          <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-10 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="Líder Territorial">
                        Líder Territorial
                      </option>
              ...
              <div className="pt-4 flex gap-4">
                ...
                >
                  <Mail size={16} />{" "}
                  {editingMember ? "Actualizar Miembro" : "Enviar Invitación"}
                </button>
              </div>
            </form>
          </div>
