...
export function AiAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      text: "Hola, soy Gemini. Estoy analizando los datos de tu campaña Colombia 2026. ¿En qué puedo ayudarte hoy?",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          actionable: json.data.actionable,
        },
      ]);
    } catch {
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          text: "Error al conectar con mi cerebro cognitivo.",
        },
      ]);
    } finally {
      setLoading(false);
        ...
        <Card className="w-96 border-none shadow-2xl rounded-3xl overflow-hidden bg-white animate-in zoom-in-95 duration-200">
          ...
          >
            ...
            <Button
              type="submit"
              size="icon"
              className="bg-slate-900 rounded-xl shrink-0"
            >
