-- Refresh the application/database contract marker after additive migrations.
...
BEGIN
    ...
    SET "schemaVersion" = '20260909340000_schema_contract_marker'
    WHERE "id" = 'primary'
      AND "fingerprint" ~ '^[a-f0-9]{64}$'
      AND "schemaVersion" = '20260909310000_schema_contract_marker';
